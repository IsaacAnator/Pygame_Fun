...
def game_start():
    ...
    food_position = (random.randint(1,39)*snake_dim, random.randint(1,19)*snake_dim)
    ...
    while running:
        ...
        if snake_position == food_position:
            ...
            for _ in range(snake_increase):
                snake_tail.append(snake_tail[-1])  # Append new segments to the tail
                food_position = (random.randint(1,39)*snake_dim, random.randint(1,19)*snake_dim)
        ...
        if x_pos < 0 or x_pos >= screen.get_width() or y_pos < 0 or y_pos >= screen.get_height():
            game_over = True
        ...
        while game_over: 
            ...
            game_over_text = "Score: " + str(snake_size) + "\nHigh Score: " + str(high_score) + "\n Press SPACE to try again"
            ...
            for i in range(len(game_over_text)):
                ...
                game_over_window.blit(text_window, (game_over_window_center_x - text_window_center_x, text_y))
                text_y += text_font.get_height() + 5
            screen.blit(game_over_window, (screen_center_x - game_over_window_center_x, screen_center_y - game_over_window_center_y))
